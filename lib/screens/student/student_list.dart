                                        ...
                                        children: [
                                          ...
                                          Center(
                                            child: Padding(
                                              ...
                                              child: Visibility(
                                                visible: !state.students[index].assigned,
                                                child: GestureDetector(
                                                  onTap: (){
                                                    Navigator.push(
                                                        context,
                                                ...
                                                replacement: GestureDetector(
                                                  onTap: (){
                                                    context.read<StudentCubit>().removeStudent(context: context, id: state.students[index].reg_id);
                                                  },
                                                  child: Container(height: 35,
                                                    width: w*0.7,
                                                    ...
                                                    child: Center(child: Text("Remove from Class",style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.w900),)),
                                                  ),
                                                ),
                                              ),
                                            ),
